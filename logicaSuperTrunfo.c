...
Criando o menu interativo para mostra a comparação
das cartas e o resultado.
*/
...
int main(){
    ...
    // Criando menu interativo para comparar as cartas
    ...
    printf("6. Informações adicionais (Pib per capita, Super Poder)\n");
